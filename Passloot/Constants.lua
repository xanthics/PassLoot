...
PassLoot.DefaultTemplate = {{"Desc", L["Temp Description"]}, {"Loot", { -- Choices: "de", "pass", "greed", "need", disabled is an empty table
	-- [1] = "de",
	-- [2] = "need",
	-- [3] = "greed",
}}}
...
for Key, Value in pairs(PassLoot.RollOrder) do PassLoot.RollOrderToIndex[Value] = Key end
PassLoot.RollMsg = {
