...
function module:CreateWidget()
	...
	DropDown.Info = {L["Inventory"], L["Selected rule will only match items when comparing already aquired inventory to this."]}
...
function module.Widget:GetData(RuleNum)
	...
	if (Changed) then module:SetConfigOption("Inventory", Data) end
	return Data
end
