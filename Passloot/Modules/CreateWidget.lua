...
function PassLoot:CreateSimpleDropdown(module, module_name, frame_name, module_tooltip)
...
function PassLoot:CreateTextBoxOptionalCheckBox(module, module_name, frame_name, module_tooltip, ...)
...
function PassLoot:CreateDropDownEditBox(module, dropdownframe_name)
