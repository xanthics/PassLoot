...
function module:CreateWidget()
	...
	Widget.Info = {L["Player Name"], L["Selected rule will match on player names."]}
	return Widget
end
...
function module.Widget:GetData(RuleNum)
	...
	if (Changed) then module:SetConfigOption("PlayerName", Data) end
	return Data
end
...
function module.Widget:AddNewFilter()
	...
	local NewTable = {module.NewFilterValue, false}
