...
function module:CreateWidget()
	...
	Frame.Info = {L["Confirm BoP"], L["Will click yes on BoP dialogues."]}
...
function module.Widget:AddNewFilter() module:SetConfigOption("ConfirmBoP", module.NewFilterValue) end

function module.Widget:RemoveFilter(Index) module:SetConfigOption("ConfirmBoP", nil) end

function module.Widget:DisplayWidget(Index) end

function module.Widget:GetFilterText(Index)
	local Value = self:GetData()
	if (Value) then return L["Will confirm bind!"] end
end
